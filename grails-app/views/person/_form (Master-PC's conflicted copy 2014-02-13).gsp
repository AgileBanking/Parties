...
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'p2PRelationsLeft', 'error')} ">
	<label for="p2PRelationsLeft">
		<g:message code="person.p2PRelationsLeft.label" default="P2 PR elations Left" />
...
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'p2PRelationsRight', 'error')} ">
	<label for="p2PRelationsRight">
		<g:message code="person.p2PRelationsRight.label" default="P2 PR elations Right" />
...
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'spouseFirstName', 'error')} ">
	<label for="spouseFirstName">
		<g:message code="person.spouseFirstName.label" default="Spouse First Name" />
		
	</label>
	<g:textField name="spouseFirstName" value="${personInstance?.spouseFirstName}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'spouseLastName', 'error')} ">
	<label for="spouseLastName">
		<g:message code="person.spouseLastName.label" default="Spouse Last Name" />
		
	</label>
	<g:textField name="spouseLastName" value="${personInstance?.spouseLastName}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'notes', 'error')} ">
	...
	<g:textField name="notes" value="${personInstance?.notes}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: personInstance, field: 'phones', 'error')} ">
	...
	<g:select name="phones" from="${entities.Phone.list()}" multiple="multiple" optionKey="id" size="5" value="${personInstance?.phones*.id}" class="many-to-many"/>
</div>
