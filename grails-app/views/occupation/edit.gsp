...
<html>
	...
	<body>
		<a href="#edit-occupation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-occupation" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:occupationInstance, action:'update']" method="PUT" >
