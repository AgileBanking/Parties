	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.p2PRelationsFrom}">
				<li class="fieldcontain">
					<span id="p2PRelationsFrom-label" class="property-label"><g:message code="person.p2PRelationsFrom.label" default="P2 PR elations From" /></span>
					
						<g:each in="${personInstance.p2PRelationsFrom}" var="p">
						<span class="property-value" aria-labelledby="p2PRelationsFrom-label"><g:link controller="p2PRelation" action="show" id="${p.id}">${p?.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${personInstance?.p2PRelationsTo}">
				<li class="fieldcontain">
					<span id="p2PRelationsTo-label" class="property-label"><g:message code="person.p2PRelationsTo.label" default="P2 PR elations To" /></span>
					
						<g:each in="${personInstance.p2PRelationsTo}" var="p">
						<span class="property-value" aria-labelledby="p2PRelationsTo-label"><g:link controller="p2PRelation" action="show" id="${p.id}">${p?.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${personInstance?.spouseGivenName}">
				<li class="fieldcontain">
					<span id="spouseGivenName-label" class="property-label"><g:message code="person.spouseGivenName.label" default="Spouse Given Name" /></span>
					
						<span class="property-value" aria-labelledby="spouseGivenName-label"><g:fieldValue bean="${personInstance}" field="spouseGivenName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${personInstance?.spouseFamilyName}">
				<li class="fieldcontain">
					<span id="spouseFamilyName-label" class="property-label"><g:message code="person.spouseFamilyName.label" default="Spouse Family Name" /></span>
					
						<span class="property-value" aria-labelledby="spouseFamilyName-label"><g:fieldValue bean="${personInstance}" field="spouseFamilyName"/></span>
				...
				<g:if test="${personInstance?.webProfile}">
				<li class="fieldcontain">
					<span id="webProfile-label" class="property-label"><g:message code="person.webProfile.label" default="Web Profile" /></span>
					
						<g:each in="${personInstance.webProfile}" var="w">
						<span class="property-value" aria-labelledby="webProfile-label"><g:link controller="webProfile" action="show" id="${w.id}">${w?.encodeAsHTML()}</g:link></span>
						</g:each>
