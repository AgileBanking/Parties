	...
	<body>
		...
		<div id="page-body" role="main">
			<h1>Welcome to Agile Banking: </h1>
                        <h2>Component: PARTIES</h2>
			<p>The component 'Parties' handles all entities related to Persons and Legal Entities:</p>

			<div id="controller-list" role="navigation">
				<h2>Available Controllers:</h2>
				<ul>
					<g:each var="c" in="${grailsApplication.controllerClasses.sort { it.fullName } }">
						<li class="controller"><g:link controller="${c.logicalPropertyName}">${c.fullName -'admin.' - 'Controller' - 'entities.' - 'asset.pipeline.' - 'grails.plugin.'}</g:link></li>
					</g:each>
				</ul>
			</div>
		</div>
